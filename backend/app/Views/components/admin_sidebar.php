...
<aside class="flex flex-col bg-[#F5F5F0] dark:bg-[#000000] shadow-md w-64">
    ...
    <nav class="flex-1 space-y-3 px-4 py-6">
        ...
        <a href="<?= site_url('admin/services') ?>" class="flex items-center gap-3 p-3 rounded-lg hover:bg-[#EAEAEA] dark:hover:bg-[#2C2C2C] <?= $active === 'services' ? 'bg-[#EAEAEA] dark:bg-[#2C2C2C] font-semibold' : 'text-[#333333] dark:text-[#F5F5F0]' ?>">🍕 Menu Items</a>
        ...
        <a href="<?= site_url('admin/requests') ?>" class="flex items-center gap-3 p-3 rounded-lg hover:bg-[#EAEAEA] dark:hover:bg-[#2C2C2C] <?= $active === 'requests' ? 'bg-[#EAEAEA] dark:bg-[#2C2C2C] font-semibold' : 'text-[#333333] dark:text-[#F5F5F0]' ?>">📬 Order Requests</a>
    </nav>
</aside>